...
# Project overview
Project realise several console games.
To run project:
make run-dist.
EvenGame
...
ProgressionGame
Progression with hided element will be shown to user. Find progression dependency and calculate hided member of progression.
